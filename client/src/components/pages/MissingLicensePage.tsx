...
export default function MissingLicensePage() {
    ...
    const attempt = async () => {
        ...
        const mapping = await getAccountMappingByCommonNameOrMac(commonNameOrMac);
        await handleAccountMapping(mapping, setMapping);
    ...
    return <div className="categoryWrapper">
        <div className="categoryContainer">
            ...
            <div style={{marginTop: 20}}>
                ...
                <div>
                    <input type="text" defaultValue={mapping?.external_id?.toUpperCase()} width={500} onChange={(e) => setPsp(e.target.value)} placeholder="external" readOnly={true} />
                </div>
